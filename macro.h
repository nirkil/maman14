...
#ifndef MACRO_OPEN || MACRO_CLOSE || MAX_LINE_LENGTH || ADDED_LINE_LENGTH || COL_AMMOUNT
...
void add_def_to_macro_table(struct macro_table *macro_t, char *macro_name, char *macro_def);
