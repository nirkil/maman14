...
void add_entry_to_symbol_table(char *symbol);
...
void fill_entries_output_file(symbol_table, FILE *entries_output_file);

/*fills externals output file*/
void fill_externals_output_file(assembler_table, FILE *externals_output_file);

/*fills object output file*/
void fill_object_output_file(assembler_table, FILE *object_output_file);
